...
<h3> This was going to be a process so, I knew I had to break it down. First I decided which listings I was specifically 
...
and submitting surveys.</h3>

<h3> Next I had to figure out how to get this payment data from each listing. First I figured out a way to get each listing 
...
would be running this test code a lot</h3>

<h3> Honestly, the hardest part of this challenge was decided exactly how I was going to calculate income per day. 
...
I could make daily if each job was one hour, eight hours, and a random number of hours between 1 and 8. </h3>